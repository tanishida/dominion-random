(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react-input-autosize-fork'), require('prop-types'), require('react'), require('react-dom')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react-input-autosize-fork', 'prop-types', 'react', 'react-dom'], factory) :
  (global = global || self, factory(global.ReactSelectCss = {}, global.AutosizeInput, global.PropTypes, global.React, global.ReactDOM));
}(this, function (exports, AutosizeInput, propTypes, React, reactDom) { 'use strict';
  ...
  */
  ...
  function (_React$Component) {
    ...
    _createClass(Option, [{
      ...
      value: function render() {
        ...
        return option.disabled ? React__default.createElement("div", {
          className: className,
  ...
  function (_React$Component) {
    ...
    _createClass(Value, [{
      ...
      value: function renderLabel() {
        ...
        return this.props.onClick || this.props.value.href ? React__default.createElement("a", {
          className: className,
          href: this.props.value.href,
          target: this.props.value.target,
          onMouseDown: this.handleMouseDown,
          onTouchEnd: this.handleMouseDown
        }, this.props.children) : React__default.createElement("span", {
          className: className,
          role: "option",
          "aria-selected": "true",
          id: this.props.id
    ...
    _createClass(Select, [{
      ...
      value: function renderValue(valueArray, isOpen) {
        ...
        if (!valueArray.length) {
          ...
          return showPlaceholder ? React__default.createElement("div", {
        ...
        if (this.props.multi) {
          return valueArray.map(function (value, i) {
            return React__default.createElement(ValueComponent, {
              ...
              value: value,
              values: valueArray
            }, renderLabel(value, i), React__default.createElement("span", {
      ...
      value: function renderInput(valueArray, focusedOptionIndex) {
        ...
        var inputProps = _objectSpread2({}, this.props.inputProps, {
      ...
      value: function render() {
        ...
        if (this.props.multi && !this.props.disabled && valueArray.length && !this.state.inputValue && this.state.isFocused && this.props.backspaceRemoves) {
          removeMessage = React__default.createElement("span", {
        ...
        }, this.renderHiddenField(valueArray), React__default.createElement("div", {
  ...
  function (_Component) {
    ...
    _createClass(Async, [{
      ...
      value: function render() {
        ...
        return children(_objectSpread2({}, this.props, {}, props, {
          isLoading: isLoading,
  ...
  function (_React$Component) {
    ...
    _createClass(CreatableSelect, [{
      ...
      value: function menuRenderer(params) {
        ...
        return menuRenderer(_objectSpread2({}, params, {
  ...
  function (_React$Component) {
    ...
    function AsyncCreatableSelect() {
      ...
      return _possibleConstructorReturn(this, _getPrototypeOf(AsyncCreatableSelect).apply(this, arguments));
    }
    ...
    _createClass(AsyncCreatableSelect, [{
      ...
      value: function render() {
        ...
        return React__default.createElement(Async, this.props, function (_ref) {
          var ref = _ref.ref,
              asyncProps = _objectWithoutProperties(_ref, ["ref"]);

          var asyncRef = ref;
          return React__default.createElement(CreatableSelect, asyncProps, function (_ref2) {
            var ref = _ref2.ref,
                creatableProps = _objectWithoutProperties(_ref2, ["ref"]);

            var creatableRef = ref;
            return _this.props.children(_objectSpread2({}, creatableProps, {
...
//# sourceMappingURL=react-select-css.js.map
