...
var _reactInputAutosizeFork = _interopRequireDefault(require("react-input-autosize-fork"));
...
function (_React$Component) {
  ...
  function Select(props) {
    ...
    ["clearValue", "focusOption", "getOptionLabel", "handleInputBlur", "handleInputChange", "handleInputFocus", "handleInputValueChange", "handleKeyDown", "handleMenuScroll", "handleMouseDown", "handleMouseDownOnArrow", "handleMouseDownOnMenu", "handleTouchEnd", "handleTouchEndClearValue", "handleTouchMove", "handleTouchOutside", "handleTouchStart", "handleValueClick", "onOptionRef", "removeValue", "selectValue"].forEach(function (fn) {
      return _this[fn] = _this[fn].bind((0, _assertThisInitialized2.default)(_this));
    });
  ...
  (0, _createClass2.default)(Select, [{
    ...
    value: function renderInput(valueArray, focusedOptionIndex) {
      ...
      var ariaOwns = (0, _classnames.default)((_classNames = {}, (0, _defineProperty2.default)(_classNames, "".concat(this._instancePrefix, "-list"), isOpen), (0, _defineProperty2.default)(_classNames, "".concat(this._instancePrefix, "-backspace-remove-message"), this.props.multi && !this.props.disabled && this.state.isFocused && !this.state.inputValue), _classNames));
      ...
      if (this.props.disabled || !this.props.searchable) {
        var divProps = (0, _extends2.default)({}, this.props.inputProps);

        var _ariaOwns = (0, _classnames.default)((0, _defineProperty2.default)({}, "".concat(this._instancePrefix, "-list"), isOpen));
      ...
      if (this.props.autosize) {
        return _react.default.createElement(_reactInputAutosizeFork.default, (0, _extends2.default)({
          id: this.props.id
        }, inputProps, {
          className: className,
          minWidth: "5"
    ...
    value: function render() {
      ...
      if (this.props.multi && !this.props.disabled && valueArray.length && !this.state.inputValue && this.state.isFocused && this.props.backspaceRemoves) {
        removeMessage = _react.default.createElement("span", {
